...
# Unit tests for Aryeo::PartialListingCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Aryeo::PartialListingCollection do
  let(:instance) { Aryeo::PartialListingCollection.new }

  describe 'test an instance of PartialListingCollection' do
    it 'should create an instance of PartialListingCollection' do
      expect(instance).to be_instance_of(Aryeo::PartialListingCollection)
    end
  end
