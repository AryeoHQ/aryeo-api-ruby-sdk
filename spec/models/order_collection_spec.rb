...
# Unit tests for Aryeo::OrderCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Aryeo::OrderCollection do
  let(:instance) { Aryeo::OrderCollection.new }

  describe 'test an instance of OrderCollection' do
    it 'should create an instance of OrderCollection' do
      expect(instance).to be_instance_of(Aryeo::OrderCollection)
    end
  end
