...
module Aryeo
  ...
  class Image
    ...
    attr_accessor :display_in_gallery
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Aryeo::Image` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Aryeo::Image`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'display_in_gallery')
        self.display_in_gallery = attributes[:'display_in_gallery']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@caption.nil? && @caption.to_s.length > 255
        invalid_properties.push('invalid value for "caption", the character length must be smaller than or equal to 255.')
      end

      if !@caption.nil? && @caption.to_s.length < 1
        invalid_properties.push('invalid value for "caption", the character length must be great than or equal to 1.')
      end

      if @display_in_gallery.nil?
        invalid_properties.push('invalid value for "display_in_gallery", display_in_gallery cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@caption.nil? && @caption.to_s.length > 255
    ...
    def caption=(caption)
      if !caption.nil? && caption.to_s.length > 255
        fail ArgumentError, 'invalid value for "caption", the character length must be smaller than or equal to 255.'
      end

      if !caption.nil? && caption.to_s.length < 1
        fail ArgumentError, 'invalid value for "caption", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          index == o.index &&
          caption == o.caption &&
          display_in_gallery == o.display_in_gallery
    end
